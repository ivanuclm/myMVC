...
#Symfony reemplaza las superglobales de PHP ($_GET, $_POST, $_COOKIE, ...) con una capa OOP

#Este código comprueba si cada URL de cada request existe en las rutas de routes/web.php. Si existe, call_user_func_array() llama al método requerido del Controller correspondiente.
class Router
{
